...
def parse_args():
    ...
    parser.add_argument('--lambda1', default=1e-5, type=float, help='weight of cl loss')
    parser.add_argument('--epoch', default=700, type=int, help='number of epochs')
    ...
    parser.add_argument('--data', default='kuai',type=str,help='name of dataset')
    ...
    parser.add_argument('--lambda3', default=1e-7, type=float, help='l3 reg weight')
